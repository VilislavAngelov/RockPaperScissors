...
void main() {
	...
	`}function kp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===pa||l===ma,u=l===Ti||l===Ai;if(c||u){let h=e.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new ul(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const m=o.image;return c&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new ul(i)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Hp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Qr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Vp(i,e,t,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let f=0,p=v.length;f<p;f++)e.remove(v[f])}d.removeEventListener("dispose",a),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const v=m[g];for(let f=0,p=v.length;f<p;f++)e.update(v[f],i.ARRAY_BUFFER)}}function c(h){const d=[],m=h.index,g=h.attributes.position;let v=0;if(m!==null){const T=m.array;v=m.version;for(let y=0,A=T.length;y<A;y+=3){const D=T[y+0],R=T[y+1],b=T[y+2];d.push(D,R,R,b,b,D)}}else if(g!==void 0){const T=g.array;v=g.version;for(let y=0,A=T.length/3-1;y<A;y+=3){const D=y+0,R=y+1,b=y+2;d.push(D,R,R,b,b,D)}}else return;const f=new(wc(d)?Dc:Ic)(d,1);f.version=v;const p=s.get(h);p&&e.remove(p),s.set(h,f)}function u(h){const d=s.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Gp(i,e,t){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,m){i.drawElements(n,m,s,d*a),t.update(m,n,1)}function c(d,m,g){g!==0&&(i.drawElementsInstanced(n,m,s,d*a,g),t.update(m,n,g))}function u(d,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,g);let f=0;for(let p=0;p<g;p++)f+=m[p];t.update(f,n,1)}function h(d,m,g,v){if(g===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let p=0;p<d.length;p++)c(d[p]/a,m[p],v[p]);else{f.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,v,0,g);let p=0;for(let T=0;T<g;T++)p+=m[T];for(let T=0;T<v.length;T++)t.update(p,n,v[T])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Wp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Xp(i,e,t){const n=new WeakMap,r=new Xe;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let _=function(){N.dispose(),n.delete(o),o.removeEventListener("dispose",_)};var m=_;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,f=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let A=0;g===!0&&(A=1),v===!0&&(A=2),f===!0&&(A=3);let D=o.attributes.position.count*A,R=1;D>e.maxTextureSize&&(R=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const b=new Float32Array(D*R*4*h),N=new Cc(b,D,R,h);N.type=Yt,N.needsUpdate=!0;const $=A*4;for(let S=0;S<h;S++){const V=p[S],z=T[S],q=y[S],j=D*R*4*S;for(let H=0;H<V.count;H++){const K=H*$;g===!0&&(r.fromBufferAttribute(V,H),b[j+K+0]=r.x,b[j+K+1]=r.y,b[j+K+2]=r.z,b[j+K+3]=0),v===!0&&(r.fromBufferAttribute(z,H),b[j+K+4]=r.x,b[j+K+5]=r.y,b[j+K+6]=r.z,b[j+K+7]=0),f===!0&&(r.fromBufferAttribute(q,H),b[j+K+8]=r.x,b[j+K+9]=r.y,b[j+K+10]=r.z,b[j+K+11]=q.itemSize===4?r.w:1)}}d={count:h,texture:N,size:new Te(D,R)},n.set(o,d),o.addEventListener("dispose",_)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let f=0;f<c.length;f++)g+=c[f];const v=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function qp(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class Bc extends dt{constructor(e,t,n,r,s,a,o,l,c,u=Mi){if(u!==Mi&&u!==Ri)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Mi&&(n=$n),n===void 0&&u===Ri&&(n=wi),super(null,r,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Tt,this.minFilter=l!==void 0?l:Tt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const zc=new dt,pl=new Bc(1,1),kc=new Cc,Hc=new Ih,Vc=new Fc,ml=[],gl=[],_l=new Float32Array(16),xl=new Float32Array(9),vl=new Float32Array(4);function Ni(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ml[r];if(s===void 0&&(s=new Float32Array(r),ml[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function lt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ct(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function gs(i,e){let t=gl[e];t===void 0&&(t=new Int32Array(e),gl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Yp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2fv(this.addr,e),ct(t,e)}}function jp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(lt(t,e))return;i.uniform3fv(this.addr,e),ct(t,e)}}function Zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4fv(this.addr,e),ct(t,e)}}function $p(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;vl.set(n),i.uniformMatrix2fv(this.addr,!1,vl),ct(t,n)}}function Jp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;xl.set(n),i.uniformMatrix3fv(this.addr,!1,xl),ct(t,n)}}function Qp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(lt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(lt(t,n))return;_l.set(n),i.uniformMatrix4fv(this.addr,!1,_l),ct(t,n)}}function em(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function tm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2iv(this.addr,e),ct(t,e)}}function nm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;i.uniform3iv(this.addr,e),ct(t,e)}}function im(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4iv(this.addr,e),ct(t,e)}}function rm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function sm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(lt(t,e))return;i.uniform2uiv(this.addr,e),ct(t,e)}}function am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(lt(t,e))return;i.uniform3uiv(this.addr,e),ct(t,e)}}function om(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(lt(t,e))return;i.uniform4uiv(this.addr,e),ct(t,e)}}function lm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(pl.compareFunction=bc,s=pl):s=zc,t.setTexture2D(e||s,r)}function cm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Hc,r)}function um(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Vc,r)}function hm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||kc,r)}function dm(i){switch(i){case 5126:return Yp;case 35664:return Kp;case 35665:return jp;case 35666:return Zp;case 35674:return $p;case 35675:return Jp;case 35676:return Qp;case 5124:case 35670:return em;case 35667:case 35671:return tm;case 35668:case 35672:return nm;case 35669:case 35673:return im;case 5125:return rm;case 36294:return sm;case 36295:return am;case 36296:return om;case 35678:case 36198:case 36298:case 36306:case 35682:return lm;case 35679:case 36299:case 36307:return cm;case 35680:case 36300:case 36308:case 36293:return um;case 36289:case 36303:case 36311:case 36292:return hm}}function fm(i,e){i.uniform1fv(this.addr,e)}function pm(i,e){const t=Ni(e,this.size,2);i.uniform2fv(this.addr,t)}function mm(i,e){const t=Ni(e,this.size,3);i.uniform3fv(this.addr,t)}function gm(i,e){const t=Ni(e,this.size,4);i.uniform4fv(this.addr,t)}function _m(i,e){const t=Ni(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function xm(i,e){const t=Ni(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function vm(i,e){const t=Ni(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Mm(i,e){i.uniform1iv(this.addr,e)}function Sm(i,e){i.uniform2iv(this.addr,e)}function ym(i,e){i.uniform3iv(this.addr,e)}function Em(i,e){i.uniform4iv(this.addr,e)}function Tm(i,e){i.uniform1uiv(this.addr,e)}function Am(i,e){i.uniform2uiv(this.addr,e)}function bm(i,e){i.uniform3uiv(this.addr,e)}function wm(i,e){i.uniform4uiv(this.addr,e)}function Rm(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||zc,s[a])}function Cm(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Hc,s[a])}function Pm(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Vc,s[a])}function Lm(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);lt(n,s)||(i.uniform1iv(this.addr,s),ct(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||kc,s[a])}function Im(i){switch(i){case 5126:return fm;case 35664:return pm;case 35665:return mm;case 35666:return gm;case 35674:return _m;case 35675:return xm;case 35676:return vm;case 5124:case 35670:return Mm;case 35667:case 35671:return Sm;case 35668:case 35672:return ym;case 35669:case 35673:return Em;case 5125:return Tm;case 36294:return Am;case 36295:return bm;case 36296:return wm;case 35678:case 36198:case 36298:case 36306:case 35682:return Rm;case 35679:case 36299:case 36307:return Cm;case 35680:case 36300:case 36308:case 36293:return Pm;case 36289:case 36303:case 36311:case 36292:return Lm}}class Dm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=dm(t.type)}}class Um{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Im(t.type)}}class Nm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const Ks=/(\w+)(\])?(\[|\.)?/g;function Ml(i,e){i.seq.push(e),i.map[e.id]=e}function Fm(i,e,t){const n=i.name,r=n.length;for(Ks.lastIndex=0;;){const s=Ks.exec(n),a=Ks.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Ml(t,c===void 0?new Dm(o,i,e):new Um(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new Nm(o),Ml(t,h)),t=h}}}class es{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);Fm(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Sl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Om=37297;let Bm=0;function zm(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function km(i){const e=Ve.getPrimaries(Ve.workingColorSpace),t=Ve.getPrimaries(i);let n;switch(e===t?n="":e===ls&&t===os?n="LinearDisplayP3ToLinearSRGB":e===os&&t===ls&&(n="LinearSRGBToLinearDisplayP3"),i){case pt:case fs:return[n,"LinearTransferOETF"];case Mt:case co:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function yl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+zm(i.getShaderSource(e),a)}else return r}function Hm(i,e){const t=km(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Vm(i,e){let t;switch(e){case Hu:t="Linear";break;case Vu:t="Reinhard";break;case Gu:t="Cineon";break;case Wu:t="ACESFilmic";break;case qu:t="AgX";break;case Yu:t="Neutral";break;case Xu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Or=new L;function Gm(){Ve.getLuminanceCoefficients(Or);const i=Or.x.toFixed(4),e=Or.y.toFixed(4),t=Or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Wm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ji).join(`
`)}function Xm(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function qm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function ji(i){return i!==""}function El(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Tl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ym=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wa(i){return i.replace(Ym,jm)}const Km=new Map;function jm(i,e){let t=Ie[e];if(t===void 0){const n=Km.get(e);if(n!==void 0)t=Ie[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Wa(t)}const Zm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Al(i){return i.replace(Zm,$m)}function $m(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function bl(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Jm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===uc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Mu?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===pn&&(e="SHADOWMAP_TYPE_VSM"),e}function Qm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ti:case Ai:e="ENVMAP_TYPE_CUBE";break;case ds:e="ENVMAP_TYPE_CUBE_UV";break}return e}function eg(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ai:e="ENVMAP_MODE_REFRACTION";break}return e}function tg(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case hc:e="ENVMAP_BLENDING_MULTIPLY";break;case zu:e="ENVMAP_BLENDING_MIX";break;case ku:e="ENVMAP_BLENDING_ADD";break}return e}function ng(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ig(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Jm(t),c=Qm(t),u=eg(t),h=tg(t),d=ng(t),m=Wm(t),g=Xm(s),v=r.createProgram();let f,p,T=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`,blending:ra,depthTest:!1,depthWrite:!1,transparent:!0})}}xn.BlurDirectionX=new Te(1,0);xn.BlurDirectionY=new Te(0,1);class lx extends fr{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Et?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ho.clone(e.uniforms),this.material=new Et({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new tu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class nc extends fr{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const r=e.getContext(),s=e.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),s.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),s.buffers.stencil.setClear(o),s.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(r.EQUAL,1,4294967295),s.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),s.buffers.stencil.setLocked(!0)}}class cx extends fr{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class ux{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Te);this._width=n.width,this._height=n.height,t=new St(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:zt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new lx(nu),this.copyPass.material.blending=jt,this.clock=new Jc}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let r=0,s=this.passes.length;r<s;r++){const a=this.passes[r];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(r),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}nc!==void 0&&(a instanceof nc?n=!0:a instanceof cx&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Te);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class hx extends fr{constructor(e,t,n=null,r=null,s=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=s,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Me}render(e,t,n){const r=e.autoClear;e.autoClear=!1;let s,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(s=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(s),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}}let qr,ts,ar=0,or=0,ns,is,Zi=[],$i=[],rs=[],lr=!0;const ja="rock",cr="paper",ur="scissors",Qt=new Fg,Nn=new yt(75,window.innerWidth/window.innerHeight,.1,1e3),pr=new Ng;pr.setSize(window.innerWidth,window.innerHeight);document.body.appendChild(pr.domElement);const dx=new Jn(30,20),fx=new Kt({color:10471164,side:Rt}),px=new ht(dx,fx);Qt.add(px);const mx=new Jn(30,20),gx=new Kt({color:9022169,side:Rt}),Ao=new ht(mx,gx);Qt.add(Ao);Ao.rotation.x=-.5*Math.PI;Ao.position.y=-1.5;const iu=new yo(16777215,1);iu.position.set(0,5,0);Qt.add(iu);const ru=new yo(16777215,3.5);ru.position.set(0,8,10);Qt.add(ru);const Za=new Kt({color:16711680,transparent:!0,opacity:0}),$a=new Kt({color:65280,transparent:!0,opacity:0}),su=new Jn(20,20),au=new ht(su,Za),ou=new ht(su,$a);Qt.add(ou);Qt.add(au);ou.position.z=9;au.position.z=9;let Ji,Ja,Qa,eo;const _x=new Zc,xx=new h_(_x),vx=["gruntWin","gruntLose","ShakeWoosh","roundWin"],lu=new f_;Nn.add(lu);vx.forEach(i=>{const e=new p_(lu);e.name=i,i==="gruntWin"&&(Ji=e),i==="gruntLose"&&(Ja=e),i==="ShakeWoosh"&&(Qa=e),i==="roundWin"&&(eo=e),xx.load(`./sfx/${i}.mp3`,function(t){e.setBuffer(t)})});let mr;const ei=new xn(new Te(window.innerWidth,window.innerHeight),Qt,Nn),ti=new xn(new Te(window.innerWidth,window.innerHeight),Qt,Nn),Mx=new hx(Qt,Nn);mr=new ux(pr);mr.addPass(Mx);mr.addPass(ei);mr.addPass(ti);ei.edgeStrength=5;ei.edgeGlow=1;ei.usePatternTexture=!1;ei.visibleEdgeColor.set(65280);ei.hiddenEdgeColor.set(65280);ti.edgeStrength=5;ti.edgeGlow=1;ti.usePatternTexture=!1;ti.visibleEdgeColor.set(16711680);ti.hiddenEdgeColor.set(16711680);Nn.position.z=10;window.addEventListener("resize",function(){const i=window.innerWidth,e=window.innerHeight;pr.setSize(i,e),Nn.aspect=i/e,Nn.updateProjectionMatrix()});window.dispatchEvent(new Event("resize"));const cu=new T_;let ic=0;cu.load("RiggedArms.glb",function(i){ns=i.scene,Qt.add(ns),uu(ns,Zi,"computer"),hu()},void 0,function(i){console.error(i)});cu.load("RiggedArms.glb",function(i){is=i.scene,Qt.add(is),uu(is,$i,"player"),hu()},void 0,function(i){console.error(i)});function uu(i,e,t){i.rotation.order="YZX",t==="computer"?(window.innerWidth<600?i.position.set(5.2,0,2):i.position.set(6,0,2),i.rotation.set(0,0,0),i.rotation.y=Math.PI,i.rotation.z=Math.PI/2,i.rotation.x=Math.PI):(window.innerWidth<600?i.position.set(-5.2,0,2):i.position.set(-6,0,2),i.rotation.set(0,0,0),i.rotation.y=0,i.rotation.z=Math.PI/2,i.rotation.x=-Math.PI),i.traverse(function(n){n.isBone&&e.push(n)}),Sx(e)}function Sx(i){const t=gsap.timeline();t.to(i[3].rotation,{z:i[3].rotation.z-.5,duration:1},0),t.to(i[4].rotation,{y:i[4].rotation.y-1,duration:1},0),t.to(i[5].rotation,{z:i[5].rotation.z-1.3,duration:1},0),t.to(i[7].rotation,{z:i[7].rotation.z-1.3,duration:1},0),t.to(i[8].rotation,{z:i[8].rotation.z-1,duration:1},0),t.to(i[9].rotation,{z:i[9].rotation.z-1,duration:1},0),t.to(i[11].rotation,{x:i[11].rotation.x+1.3,duration:1},0),t.to(i[12].rotation,{x:i[12].rotation.x+1,duration:1},0),t.to(i[13].rotation,{x:i[13].rotation.x+1,duration:1},0),t.to(i[15].rotation,{z:i[15].rotation.z+1.3,duration:1},0),t.to(i[16].rotation,{z:i[16].rotation.z+1,duration:1},0),t.to(i[17].rotation,{z:i[17].rotation.z+1,duration:1},0),t.to(i[19].rotation,{z:i[19].rotation.z+1.3,duration:1},0),t.to(i[20].rotation,{z:i[20].rotation.z+1,duration:1},0),t.to(i[21].rotation,{z:i[21].rotation.z+1,duration:1},0),t.call(()=>yx(i))}function yx(i){i.forEach((e,t)=>{rs[t]={x:e.rotation.x,y:e.rotation.y,z:e.rotation.z}})}function rc(i){i.forEach((t,n)=>{gsap.to(t.rotation,{x:rs[n].x,y:rs[n].y,z:rs[n].z,duration:.5})})}function hu(){ic++,ic===2&&(ei.selectedObjects.push(is),ti.selectedObjects.push(ns),gsap.delayedCall(.6,du))}function sc(i,e){if(!i[0]){console.error("bones[0] is undefined in shakeHand"),e&&e();return}const r=i[0].rotation.z,s=gsap.timeline({onComplete:e});s.to(i[0].rotation,{z:r-.2,duration:.1},0);for(let a=0;a<2;a++)s.to(i[0].rotation,{z:r,duration:.1}),s.to(i[0].rotation,{z:r-.2,duration:.1});s.to(i[0].rotation,{z:r,duration:.1})}function ac(i){gsap.to(i[3].rotation,{z:i[3].rotation.z+.5,duration:.2}),gsap.to(i[4].rotation,{y:i[4].rotation.y+1,duration:.2}),gsap.to(i[5].rotation,{z:i[5].rotation.z+1.3,duration:.2}),gsap.to(i[7].rotation,{z:i[7].rotation.z+1.3,duration:.2}),gsap.to(i[8].rotation,{z:i[8].rotation.z+1,duration:.2}),gsap.to(i[9].rotation,{z:i[9].rotation.z+1,duration:.2}),gsap.to(i[11].rotation,{x:i[11].rotation.x-1.3,duration:.2}),gsap.to(i[12].rotation,{x:i[12].rotation.x-1,duration:.2}),gsap.to(i[13].rotation,{x:i[13].rotation.x-1,duration:.2}),gsap.to(i[15].rotation,{z:i[15].rotation.z-1.3,duration:.2}),gsap.to(i[16].rotation,{z:i[16].rotation.z-1,duration:.2}),gsap.to(i[17].rotation,{z:i[17].rotation.z-1,duration:.2}),gsap.to(i[19].rotation,{z:i[19].rotation.z-1.3,duration:.2}),gsap.to(i[20].rotation,{z:i[20].rotation.z-1,duration:.2}),gsap.to(i[21].rotation,{z:i[21].rotation.z-1,duration:.2})}function oc(i){gsap.to(i[7].rotation,{z:i[7].rotation.z+1.3,duration:.2}),gsap.to(i[8].rotation,{z:i[8].rotation.z+1,duration:.2}),gsap.to(i[9].rotation,{z:i[9].rotation.z+1,duration:.2}),gsap.to(i[11].rotation,{x:i[11].rotation.x-1.3,duration:.2}),gsap.to(i[12].rotation,{x:i[12].rotation.x-1,duration:.2}),gsap.to(i[13].rotation,{x:i[13].rotation.x-1,duration:.2})}function du(){let i=document.getElementsByClassName("rps-btn");Array.from(i).forEach(function(e){e.addEventListener("click",fu)})}function fu(i){lr&&(ts=i.target.textContent.toLowerCase(),lr=!1,Ex())}function Ex(){qr=Ax(),Qa.stop(),Qa.play(),sc(Zi,()=>{qr===cr?ac(Zi):qr===ur&&oc(Zi),gsap.delayedCall(.5,()=>{rc(Zi)})}),sc($i,()=>{ts===cr?ac($i):ts===ur&&oc($i),gsap.delayedCall(.5,()=>{rc($i)})}),gsap.delayedCall(.5,()=>{Tx(ts,qr),(or==5||ar==5)&&wx(),lr=!0})}function Tx(i,e){i===e?(document.getElementById("roundWinText").style.display="none",document.getElementById("roundLoseText").style.display="none",document.getElementById("roundDrawText").style.display="block",Ji.stop(),Ji.play()):i===ja&&e===ur||i===cr&&e===ja||i===ur&&e===cr?(document.getElementById("roundWinText").style.display="block",document.getElementById("roundLoseText").style.display="none",document.getElementById("roundDrawText").style.display="none",Ji.stop(),Ji.play(),eo.stop(),eo.play(),Px(),lc("player")):(document.getElementById("roundWinText").style.display="none",document.getElementById("roundLoseText").style.display="block",document.getElementById("roundDrawText").style.display="none",Cx(),Lx(Nn,.3,.3),Ja.stop(),Ja.play(),lc("computer"))}function Ax(){const i=[ja,cr,ur],e=Math.floor(Math.random()*3);return i[e]}function bx(){mr.render()}pr.setAnimationLoop(bx);function lc(i){if(i=="player"){or++;for(let e=1;e<=or;e++)document.querySelector(`.playerRoundsWon li:nth-child(${e}) img`).style.filter="invert(92%) sepia(14%) saturate(3585%) hue-rotate(358deg) brightness(104%) contrast(105%)"}else{ar++;for(let e=1;e<=ar;e++)document.querySelector(`.computerRoundsWon li:nth-child(${6-e}) img`).style.filter="invert(92%) sepia(14%) saturate(3585%) hue-rotate(358deg) brightness(104%) contrast(105%)"}}function wx(){lr=!1;let i=document.getElementsByClassName("rps-btn");Array.from(i).forEach(function(e){e.removeEventListener("click",fu)}),or==5?(document.getElementById("roundWinText").style.display="none",document.getElementById("gameWinText").style.display="block",cc()):ar==5&&(document.getElementById("roundLoseText").style.display="none",document.getElementById("gameLoseText").style.display="block",cc())}function cc(){document.getElementById("btn-rock").style.display="none",document.getElementById("btn-paper").style.display="none",document.getElementById("btn-scissors").style.display="none",document.getElementById("btn-reset").style.display="block",document.getElementById("btn-reset").addEventListener("click",Rx)}function Rx(){document.getElementById("btn-rock").style.display="block",document.getElementById("btn-paper").style.display="block",document.getElementById("btn-scissors").style.display="block",document.getElementById("btn-reset").style.display="none",or=0,ar=0,git,document.querySelectorAll(".starWon img").forEach(function(e){e.style.filter="invert(100%) sepia(0%) saturate(7500%) hue-rotate(258deg) brightness(109%) contrast(98%)"}),document.getElementById("gameWinText").style.display="none",document.getElementById("gameLoseText").style.display="none",lr=!0,du()}function Cx(){Za.opacity=.5,gsap.to(Za,{opacity:0,duration:.5,ease:"power1.out"})}function Px(){$a.opacity=.5,gsap.to($a,{opacity:0,duration:.5,ease:"power1.out"})}function Lx(i,e=.05,t=.3){const n={x:i.position.x,y:i.position.y,z:i.position.z};gsap.to(i.position,{x:n.x+(Math.random()-.5)*e,y:n.y+(Math.random()-.5)*e,z:n.z+(Math.random()-.5)*e,duration:.05,ease:"power1.inOut",yoyo:!0,repeat:Math.floor(t/.05),onComplete:()=>{i.position.set(n.x,n.y,n.z)}})}
